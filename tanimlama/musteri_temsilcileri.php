<?
	...
	session_kontrol();
	$rows		= $cSubData->getMusteriTemsilcileri();
?>
<!DOCTYPE html>
...
<body class="mod-bg-1">
    ...
    <main id="js-page-content" role="main" class="page-content">
	  	<ol class="breadcrumb page-breadcrumb breadcrumb-seperator-1">
            ...
            <li class="breadcrumb-item active"><?=dil("Müşteri Temsilcileri")?></li>
                            ...
                            <div class="col-xl-4">
                                <div id="c_<?=$key?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?=fncYaziKucult($row->UNVAN)?>">
                                    <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                        <div class="d-flex flex-row align-items-center">
                                            <span class="status status-success mr-3">
                                                <span class="rounded-circle profile-image d-block " style="background-image:url('/smartadmin/img/demo/php.png'); background-size: cover;"></span>
                                            </span>
                                            <div class="info-card-text flex-1">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="/kullanici/duzenle.do?route=kullanici/kullanicilar&id=<?=$row->ID?>&kod=<?=$row->KOD?>"><?=dil("Düzenle")?></a>
                                                    <a class="dropdown-item" href="#"><?=dil("Mail Gönder")?></a>
                                                    <a class="dropdown-item" href="#"><?=dil("Pasif Yap")?></a>
                                                </div>
                                                <span class="text-truncate text-truncate-xl"><?=$row->YETKI?> - <?=FormatTarih::tarih(FormatTarih::Date($row->TARIH))?></span>
                                            </div>
                                    ...
                                    <div class="card-body p-0 collapse show">
                                        <div class="p-3">
                                        	<div class="mt-1 d-block fs-sm fw-400 text-dark"><i class="fas fa-user text-muted mr-2"></i> <?=$row->KULLANICI?> </div>
                                            <a href="tel:<?=$row->CEPTEL?>" class="mt-1 d-block fs-sm fw-400 text-dark"><i class="fas fa-mobile-alt text-muted mr-2"></i> <?=$row->CEPTEL?> </a>
                                            <a href="mailto:<?=$row->MAIL?>" class="mt-1 d-block fs-sm fw-400 text-dark"><i class="fas fa-mouse-pointer text-muted mr-2"></i> <?=$row->MAIL?> </a>
                                            <address class="fs-sm fw-400 mt-4 text-muted"><i class="fas fa-map-pin mr-2"></i> <?=$row->ADRES?> </address>
                                            <div class="d-flex flex-row">
                                                <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#3b5998"><i class="fab fa-facebook-square"></i> </a>
                                                <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#38A1F3"> <i class="fab fa-twitter-square"></i> </a>
                                                <a href="javascript:void(0);" class="mr-2 fs-xxl" style="color:#0077B5"> <i class="fab fa-linkedin"></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
