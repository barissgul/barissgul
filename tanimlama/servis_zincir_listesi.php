<?
	...
	session_kontrol();
	$rows		= $cSubData->getServisZincirler();
?>
<!DOCTYPE html>
...
<body class="mod-bg-1">
    ...
    <main id="js-page-content" role="main" class="page-content">
	  	<ol class="breadcrumb page-breadcrumb breadcrumb-seperator-1">
            ...
            <li class="breadcrumb-item active"><?=dil("Servis Zinciri")?></li>
                                ...
                                <div id="c_<?=$key?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?=fncYaziKucult($row->UNVAN)?>">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            ...
                                            <div class="info-card-text flex-1">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="/kullanici/duzenle.do?route=kullanici/kullanicilar&id=<?=$row->ID?>&kod=<?=$row->KOD?>"><?=dil("Kullanıcı Düzenle")?></a>
                                    ...
                                    <div class="card-body p-0 collapse show">
                                        <div class="p-3">
                                            ...
                                            <a href="tel:<?=$row->CEPTEL?>" class="mt-2 d-block fs-sm fw-400 text-dark"><i class="fas fa-mobile-alt text-muted mr-2"></i> <?=$row->CEPTEL?> </a>
                                            <a href="mailto:<?=$row->MAIL?>" class="mt-2 d-block fs-sm fw-400 text-dark"><i class="fas fa-mouse-pointer text-muted mr-2"></i> <?=$row->MAIL?> </a>
                                            <address class="fs-sm fw-400 mt-2 text-muted"><i class="fas fa-map-pin mr-2"></i> <?=$row->ADRES?> </address>
                                            <h5> <?=$row->SERVIS_TURU?> </h5>
                                            <div class="d-flex flex-row">
                                                <a href="/tanimlama/servis_zincir.do?route=<?=$_REQUEST['route']?>&id=<?=$row->ID?>&kod=<?=$row->KOD?>" class="text-primary mr-2 fs-xl"><i class="fas fa-edit"></i> </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
