<?
	...
	session_kontrol();
	$rows		= $cSubData->getMusteriArabalar();
?>
<!DOCTYPE html>
                            ...
                            <div class="col-xl-4">
                                <div id="c_<?=$key?>" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?=fncYaziKucult($row->UNVAN)?>">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            ...
                                            <div class="info-card-text flex-1">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="/tanimlama/arac.do?route=tanimlama/arac&id=<?=$row->ID?>&kod=<?=$row->KOD?>"><?=dil("Düzenle")?></a>
                                                </div>
                                                <span class="text-truncate text-truncate-xl"><?=$row->MARKA?> <?=$row->MODEL?> - <?=$row->MODEL_YILI?></span>
                                            </div>
                                    ...
                                    <div class="card-body p-0 collapse show">
                                        <div class="p-3">
                                        	<div class="mt-1 d-block fs-sm fw-400 text-dark"><i class="fas fa-user text-muted mr-2"></i> <?=$row->SURUCU_AD?> <?=$row->SURUCU_SOYAD?> </div>
                                            <a href="tel:<?=$row->CEPTEL?>" class="mt-1 d-block fs-sm fw-400 text-dark"><i class="fas fa-mobile-alt text-muted mr-2"></i> <?=$row->SURUCU_TEL?> </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
