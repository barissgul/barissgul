		    	...
		    	<div class="col-xl-12">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                        	<form name="form" id="form" class="" enctype="multipart/form-data" method="POST">
								...
								<div class="row">
									<div class="col-md-2 mb-2">        
									    <div class="form-group">
									      	...
									      	<input type="text" class="form-control" placeholder="" name="kodu" id="kodu" value="" maxlength="30">
									    </div>
									</div>
									<div class="col-md-2 mb-2">        
									    <div class="form-group">
									      	<label class="form-label"> <?=dil("Oem Kodu")?> </label>
									      	<input type="text" class="form-control" placeholder="" name="oem_kodu" id="oem_kodu" value="" maxlength="30">
									    </div>
									</div>
									<div class="col-md-2 mb-2">        
									    <div class="form-group">
									      	<label class="form-label"> <?=dil("Parça Adı")?> </label>
									      	<input type="text" class="form-control" placeholder="" name="stok" id="stok" value="" maxlength="50">
									    </div>
									</div>
									<div class="col-md-2">
										<div class="form-group">
