                        ...
                        <div class="panel-content">
							<form name="form" id="form" class="app-forms" enctype="multipart/form-data" method="GET">
								...
								<div class="row">
									...
									<div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 mb-2">        
									    <div class="form-group">
									...
									<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6 mb-2">        
									    <div class="form-group">
									      	...
									      	<input type="text" class="form-control" placeholder="" name="ozel_kod1" id="ozel_kod1" value="<?=$_REQUEST['ozel_kod1']?>" maxlength="20">
									    </div>
									</div>
									<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6 mb-2">        
									    <div class="form-group">
									      	<label class="form-label"> <?=dil("Logo Grup Kodu")?> </label>
									      	<input type="text" class="form-control" placeholder="" name="ozel_kod2" id="ozel_kod2" value="<?=$_REQUEST['ozel_kod2']?>" maxlength="20">
									    </div>
									</div>
									<div class="col-lg-2 col-md-3 col-sm-6 col-xs-6 mb-2">        
									    <div class="form-group">
	    		...
	    		<div class="col-md-12">
    				...
    				<div class="panel-hdr bg-primary-300 text-white">
                        ...
                        <div class="panel-toolbar">
                        	<!--
                        	<a href="/cari/cari_aktarma.do?route=cari/cari_aktarma" class="btn btn-icon btn-outline-secondary text-white border-white mr-1" title="Cari Aktarma"> <i class="far fa-user-times"></i> </a>
                        	-->
                            <a href="/cari/cari.do?route=<?=$_REQUEST['route']?>" class="btn btn-icon btn-outline-secondary text-white border-white mr-1" title="Cari Ekle"> <i class="far fa-plus"></i> </a>
		            		<a href="/excel_sql.do?" title="Excel" class="btn btn-icon btn-outline-secondary text-white border-white mr-1"> <i class="far fa-table"></i> </a>
                        </div>
                    </div>
                    <div class="panel-container show">
                        <div class="panel-content">
						  		...
						  		<table class="table table-sm table-condensed table-hover">
							  		<thead class="thead-themed fw-500">
								    	<tr>
								          	...
								          	<td><?=dil("Mail")?></td>
								          	<td><?=dil("CepTel")?></td>
								          	<td><?=dil("Müşteri Temsilcisi")?></td>
								          	<td><?=dil("Logo Cari Kodu")?></td>
							        ...
							        <tbody>
								        <?foreach($rows as $key=>$row) {?>
									        <tr>
									          	...
									          	<td><?=FormatYazi::kisalt($row->CARI,30)?></td>
									          	<td><?=$row->ULKE?></td>
									          	<td><?=$row->IL?> / <?=$row->ILCE?></td>
									          	<td><?=$row->MAIL?></td>
									          	<td><?=$row->CEPTEL?></td>
									          	<td><?=$row->MUSTERI_TEMSILCISI?></td>
									          	<td><?=$row->OZEL_KOD1?></td>
									          	<td align="center"><?=$row->DURUM?></td>
									          	<td align="center"><?=FormatTarih::tarih($row->TARIH)?></td>
									          	<td align="right" nowrap> 
									          		<a href="/kullanici/kullanicilar.do?route=kullanici/kullanicilar&cari_id=<?=$row->ID?>&filtre=1" class="btn btn-outline-info btn-icon"  title="Cari Kullanıcılar"> <i class="far fa-users-class"></i> </a>
									          		...
									          		<a href="/cari/cari.do?route=<?=$_REQUEST['route']?>&id=<?=$row->ID?>&kod=<?=$row->KOD?>" class="btn btn-outline-primary btn-icon" title="Müşteri Düzenle"> <i class="far fa-edit"></i> </a> 
									          	</td>
									        </tr>
								        <?}?>
							        </tbody>
