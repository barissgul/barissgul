<?
	...
	$Table = $cTable->setSayfa("sayfaYpOrjinalParcaListe")->setExcel($excelOut)->setPost($_REQUEST)->Uygula()->getTable();	
	$rows = $Table['rows'];
...
<body class="mod-bg-1">
    ...
    <main id="js-page-content" role="main" class="page-content">
    	<ol class="breadcrumb page-breadcrumb breadcrumb-seperator-1">
            ...
            <li class="breadcrumb-item active"><?=dil("Orjinal Parça Listesi")?></li>
	    	...
	    	<div class="row">
	    		<div class="col-md-12">
    				...
    				<div class="panel-hdr bg-primary-300 text-white">
                        <h2><i class="fa fa-list mr-3"></i> <?=dil("Orjinal Parça Listesi")?> &nbsp;<span class="small">(<?=$Table['sayfaUstYazi']?>)</span> </h2>
                        <div class="panel-toolbar">
						  		...
						  		<table class="table table-sm table-condensed table-hover">
							  		<thead class="thead-themed fw-500">
								    	<tr>
								          	...
								          	<td align="center"><?=dil("Para Birim")?></td>
								          	<td align="center"><?=dil("Birim")?></td>
								          	<td><?=dil("Adet")?></td>
								          	<td><?=dil("Stok")?></td>
								          	<td><?=dil("Kampanyalı")?></td>
								          	<td><?=dil("Parca Marka")?></td>
							        ...
							        <tbody>
								        ...
								        foreach($rows as $key=>$row) {								        	
									        ...
									        <tr>
									          	...
									          	<td align="center"><?=$row->PARA_BIRIM?></td>
									          	<td align="center"><?=$row->BIRIM?></td>
									          	<td><?=$row->ADET?></td>
									          	<td><?=$row->STOK?></td>
									          	<td><?=$row->KAMPANYALI?></td>
									          	...
									          	<td class="p-0">
									          		<a href="<?=fncYPPopupLink($row)?>" class="btn btn-outline-primary btn-icon btn-sm"> <i class="fal fa-pencil-alt"></i> </a>	
									          	</td>
									        </tr>
								        <?}?>
							        </tbody>
