;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      filterTextClear: 'tümü',
      filterPlaceHolder: 'Filtrele',
      moveSelectedLabel: 'Seçili taşı',
      moveAllLabel: 'Tümünü taşı',
      removeSelectedLabel: 'Seçiliyi sil',
      removeAllLabel: 'Tümünü Sil',
      ...
      infoText: 'Tümü göster {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="label label-warning">Filtreli</span> {0} from {1}', // when not all of the options are visible due to the filter
      infoTextEmpty: 'Boş Liste',                                                        // when there are no options present in the list
  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.moveall > i, .move > i').removeClass('far fa-arrow-right').addClass('icon-arrow-right');
        this.container.find('.removeall > i, .remove > i').removeClass('far fa-arrow-left').addClass('icon-arrow-left');
      } else {
        ...
        this.container.find('.moveall > i, .move > i').removeClass('icon-arrow-right').addClass('far fa-arrow-right');
        this.container.find('.removeall > i, .remove > i').removeClass('icon-arrow-left').addClass('far fa-arrow-left');
      }
      if (refresh) {
        refreshSelects(this);
      }
