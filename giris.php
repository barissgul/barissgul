...
<html lang="en">
	...
	<head>
		...
		<title><?php  ?></title>
		<link rel="shortcut icon" href="market/assets/images/logo/favourite_icon_01.png">

		<!-- fraimwork - css include -->
		<link rel="stylesheet" type="text/css" href="market/assets/css/bootstrap.min.css">

		<!-- icon - css include -->
		<link rel="stylesheet" type="text/css" href="market/assets/css/fontawesome.css">

		<!-- animation - css include -->
		<link rel="stylesheet" type="text/css" href="market/assets/css/animate.css">

		<!-- nice select - css include -->
		<link rel="stylesheet" type="text/css" href="market/assets/css/nice-select.css">

		<!-- carousel - css include -->
		<link rel="stylesheet" type="text/css" href="market/assets/css/slick.css">
		<link rel="stylesheet" type="text/css" href="market/assets/css/slick-theme.css">

		<!-- popup images & videos - css include -->
		<link rel="stylesheet" type="text/css" href="market/assets/css/magnific-popup.css">

		<!-- jquery ui - css include -->
		<link rel="stylesheet" type="text/css" href="market/assets/css/jquery-ui.css">

		<!-- custom - css include -->
		<link rel="stylesheet" type="text/css" href="market/assets/css/style.css">
	...
	<body class="home_carparts">
		...
		================================================== -->
		<?php require_once 'market/header.php'; ?>
		<!-- header_section - end
		================================================== -->
		...
		<main>
			...
			<div class="sidebar-menu-wrapper">
					...
					<ul class="cart_items_list ul_li_block mb_30 clearfix">
						<li>
							<div class="item_image">
								<img src="market/assets/images/cart/img_01.jpg" alt="image_not_found">
							</div>
				...
				<div class="sidebar_mobile_menu">
					...
					<div class="msb_widget brand_logo text-center">
						<a href="index.html">
							<img src="market/assets/images/logo/logo_25_1x.png" srcset="market/assets/images/logo/logo_25_2x.png 2x" alt="logo_not_found">
						</a>
					</div>
					...
					<div class="user_info">
						...
						<div class="profile_info clearfix">
							<div class="user_thumbnail">
								<img src="market/assets/images/meta/img_01.png" alt="thumbnail_not_found">
							</div>
			...
			================================================== -->
			<section class="banner_section carparts_banner parallaxie d-flex align-items-center clearfix" data-background="market/assets/images/banner/car_parts/bg_01.jpg">
				<div class="container">
					...
					<div class="row mt__50">
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
							<div class="carparts_policy_item">
								<div class="item_icon">
									<img src="market/assets/images/policy/car_parts/icon_01.png" alt="icon_not_found">
								</div>
								<div class="item_content">
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
							<div class="carparts_policy_item">
								<div class="item_icon">
									<img src="market/assets/images/policy/car_parts/icon_02.png" alt="icon_not_found">
								</div>
								<div class="item_content">
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
							<div class="carparts_policy_item">
								<div class="item_icon">
									<img src="market/assets/images/policy/car_parts/icon_03.png" alt="icon_not_found">
								</div>
								<div class="item_content">
						...
						<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
							<div class="carparts_policy_item">
								<div class="item_icon">
									<img src="market/assets/images/policy/car_parts/icon_04.png" alt="icon_not_found">
								</div>
								<div class="item_content">
					...
					<div class="carparts_category_carousel clearfix">
						<div class="item">
							<div class="primary_carparts_category">
								...
								<div class="item_image">
									<img src="market/assets/images/category/car_parts/img_01.png" alt="image_not_found">
						...
						<div class="item">
							<div class="primary_carparts_category">
								...
								<div class="item_image">
									<img src="market/assets/images/category/car_parts/img_02.png" alt="image_not_found">
									<a class="icon_btn bg_carparts_red" href="#!"><i class="fal fa-arrow-right"></i></a>
								</div>
								<div class="item_content">
									<h3 class="item_title">Stoptech</h3>
						...
						<div class="item">
							<div class="primary_carparts_category">
								...
								<div class="item_image">
									<img src="market/assets/images/category/car_parts/img_03.png" alt="image_not_found">
									<a class="icon_btn bg_carparts_red" href="#!"><i class="fal fa-arrow-right"></i></a>
								</div>
								<div class="item_content">
									<h3 class="item_title">Stoptech</h3>
						...
						<div class="item">
							<div class="primary_carparts_category">
								...
								<div class="item_image">
									<img src="market/assets/images/category/car_parts/img_04.png" alt="image_not_found">
									<a class="icon_btn bg_carparts_red" href="#!"><i class="fal fa-arrow-right"></i></a>
								</div>
								<div class="item_content">
									<h3 class="item_title">Stoptech</h3>
						...
						<div class="item">
							<div class="primary_carparts_category">
								...
								<div class="item_image">
									<img src="market/assets/images/category/car_parts/img_05.png" alt="image_not_found">
									<a class="icon_btn bg_carparts_red" href="#!"><i class="fal fa-arrow-right"></i></a>
								</div>
								<div class="item_content">
									<h3 class="item_title">Stoptech</h3>
			...
			<!-- deals_section - start
			================================================== -->
			<section class="deals_section sec_ptb_100 clearfix" data-background="market/assets/images/backgrounds/bg_01.jpg">
				<div class="container">
					...
					<div class="row justify-content-lg-between">
									...
									<div class="item">
										<div class="carparts_deals_listlayout clearfix">
											<div class="deals_image">
												<img src="market/assets/images/deals/car_parts/img_01.jpg" alt="image_not_found">
											</div>
						...
						<div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
							<div class="carparts_store_info text-white" data-background="market/assets/images/home_car_parts/img_01.jpg">
								<h3 class="item_title">
									DODGE RAM 1500 BALL JOINT FRONT
								</h3>
								<p>
						...
						<div class="tab-content mb_50 clearfix">
							<div id="service_tab" class="tab-pane active">
								<div class="row justify-content-center">
									...
									<div class="carparts_product_grid" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_01.png" alt="image_not_found">
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="carparts_product_grid" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_02.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="carparts_product_grid" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_03.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="carparts_product_grid" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_04.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="carparts_product_grid" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_05.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="carparts_product_grid" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_06.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="carparts_product_grid" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_07.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="carparts_product_grid" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_08.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="carparts_product_grid" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_09.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="carparts_product_grid" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_10.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
									<div class="carparts_product_grid" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_11.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
							...
							<div id="lighting1_tab" class="tab-pane fade">
								<div class="row justify-content-center">
									...
									<div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
										<div class="carparts_product_grid" data-bg-color="#f0eeee">
											<div class="item_image" data-bg-color="#f8f8f8">
												<img src="market/assets/images/shop/car_parts/img_12.png" alt="image_not_found">
												<ul class="product_action_btns ul_li_center clearfix">
													<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
													<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
													<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
			...
			================================================== -->
			<section class="interior_carparts_section sec_ptb_100 clearfix" data-background="market/assets/images/backgrounds/bg_02.jpg">
				<div class="container">
					<div class="row mt__30">

						<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
							<div class="Interior_carparts">
								<img src="market/assets/images/category/car_parts/img_06.jpg" alt="image_not_found">
								<div class="item_content">
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
							<div class="Interior_carparts">
								<img src="market/assets/images/category/car_parts/img_07.jpg" alt="image_not_found">
								<div class="item_content">
									<span class="sub_title">Customize, Modify</span>
									<h3 class="item_title text-white">Interior Parts</h3>
									<a class="custom_btn btn_sm bg_carparts_red text-uppercase" href="#!">Shop Now</a>
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
							<div class="Interior_carparts">
								<img src="market/assets/images/category/car_parts/img_08.jpg" alt="image_not_found">
								<div class="item_content">
									<span class="sub_title">Customize, Modify</span>
									<h3 class="item_title text-white">Interior Parts</h3>
									<a class="custom_btn btn_sm bg_carparts_red text-uppercase" href="#!">Shop Now</a>
							...
							<div class="product3_collumn_carousel row arrow_ycenter" data-slick='{"dots": false}'>
								<div class="item col">
									<div class="carparts_product_grid column_3" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_13.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="item col">
									<div class="carparts_product_grid column_3" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_14.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="item col">
									<div class="carparts_product_grid column_3" data-bg-color="#f0eeee">
										<div class="item_image" data-bg-color="#f8f8f8">
											<img src="market/assets/images/shop/car_parts/img_15.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
				...
				<div class="container">
					<div class="row justify-content-center">
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="Interior_carparts">
								<img src="market/assets/images/category/car_parts/img_09.jpg" alt="image_not_found">
								<div class="item_content">
									<span class="sub_title">Customize, Modify</span>
						...
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<div class="Interior_carparts">
								<img src="market/assets/images/category/car_parts/img_10.jpg" alt="image_not_found">
								<div class="item_content">
									<span class="sub_title">Customize, Modify</span>
									<h3 class="item_title text-white mb-0">Interior Parts</h3>
									<ul class="parts_category_list ul_li_block text-white clearfix">
							...
							<div class="carparts_dealsgrid_carousel slideshow1_slider mb-0 row" data-slick='{"arrows": false}'>
								<div class="item col">
									<div class="carparts_deals_grid">
										...
										<div class="item_image">
											<img src="market/assets/images/deals/car_parts/img_02.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="item col">
									<div class="carparts_deals_grid">
										...
										<div class="item_image">
											<img src="market/assets/images/deals/car_parts/img_03.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
								...
								<div class="item col">
									<div class="carparts_deals_grid">
										...
										<div class="item_image">
											<img src="market/assets/images/deals/car_parts/img_04.png" alt="image_not_found">
											<ul class="product_action_btns ul_li_center clearfix">
												<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
												<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
				...
				<div class="container">
					...
					<div class="product3_collumn_carousel row arrow_ycenter mb_50" data-slick='{"dots": false}'>
						<div class="item col">
							<div class="carparts_product_grid column_3" data-bg-color="#f0eeee">
								<div class="item_image" data-bg-color="#f8f8f8">
									<img src="market/assets/images/shop/car_parts/img_16.png" alt="image_not_found">
									<ul class="product_action_btns ul_li_center clearfix">
										<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
										<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
										<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
						...
						<div class="item col">
							<div class="carparts_product_grid column_3" data-bg-color="#f0eeee">
								<div class="item_image" data-bg-color="#f8f8f8">
									<img src="market/assets/images/shop/car_parts/img_17.png" alt="image_not_found">
									<ul class="product_action_btns ul_li_center clearfix">
										<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
										<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
										<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
						...
						<div class="item col">
							<div class="carparts_product_grid column_3" data-bg-color="#f0eeee">
								<div class="item_image" data-bg-color="#f8f8f8">
									<img src="market/assets/images/shop/car_parts/img_18.png" alt="image_not_found">
									<ul class="product_action_btns ul_li_center clearfix">
										<li><a class="tooltips" data-placement="top" title="Add To Wishlist" href="#!"><i class="fal fa-heart"></i></a></li>
										<li><a class="tooltips" data-placement="top" title="Add To Cart" href="#!"><i class="fal fa-shopping-basket"></i></a></li>
										<li><a class="tooltips" data-placement="top" title="Quick View" href="#!" data-toggle="modal" data-target="#quickview_modal"><i class="fal fa-search"></i></a></li>
			...
			================================================== -->
			<section class="new_carparts_section sec_ptb_100 parallaxie black_overlay clearfix" data-background="market/assets/images/backgrounds/bg_03.jpg">
				<div class="container">
					...
					<div class="row align-items-center justify-content-lg-between justify-content-md-center justify-content-sm-center">
						<div class="col-lg-8 col-md-8 col-sm-10 col-xs-12">
							<ul class="new_carparts_images ul_li clearfix">
								<li>
									<img src="market/assets/images/shop/car_parts/img_19.jpg" alt="image_not_found">
								</li>
								<li>
									<img src="market/assets/images/shop/car_parts/img_20.jpg" alt="image_not_found">
								</li>
							</ul>
						</div>
					...
					<div class="carparts_blog_listlayout">
						<div class="row align-items-center justify-content-lg-between">
							<div class="col-lg-7 col-md-6 col-sm-12 col-xs-12">
								<div class="item_image">
									<img src="market/assets/images/blog/car_parts/img_01.jpg" alt="image_not_found">
								</div>
							</div>
					...
					<div class="carparts_blog_listlayout">
						<div class="row align-items-center justify-content-lg-between">
							<div class="col-lg-7 col-md-6 col-sm-12 col-xs-12 order-last">
								<div class="item_image">
									<img src="market/assets/images/blog/car_parts/img_02.jpg" alt="image_not_found">
								</div>
							</div>
							<div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
								<div class="item_content">
					...
					<div class="barnd_carousel clearfix">
						<div class="item">
							<a class="brand_item" href="#!">
								<img src="market/assets/images/brands/img_01.png" alt="image_not_found">
							</a>
						</div>

						<div class="item">
							<a class="brand_item" href="#!">
								<img src="market/assets/images/brands/img_02.png" alt="image_not_found">
							</a>
						</div>

						<div class="item">
							<a class="brand_item" href="#!">
								<img src="market/assets/images/brands/img_03.png" alt="image_not_found">
							</a>
						</div>

						<div class="item">
							<a class="brand_item" href="#!">
								<img src="market/assets/images/brands/img_04.png" alt="image_not_found">
							</a>
						</div>

						<div class="item">
							<a class="brand_item" href="#!">
								<img src="market/assets/images/brands/img_05.png" alt="image_not_found">
							</a>
						</div>

						<div class="item">
							<a class="brand_item" href="#!">
								<img src="market/assets/images/brands/img_06.png" alt="image_not_found">
							</a>
						</div>
						...
						<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
							<div class="footer_widget footer_about">
								<div class="brand_logo mb_30">
									<a href="index.html">
										<img src="market/assets/images/logo/logo_02_1x.png" srcset="market/assets/images/logo/logo_02_2x.png 2x" alt="logo_not_found">
									</a>
								</div>
						...
						<div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
							<div class="footer_widget footer_instagram">
								...
								<ul class="zoom-gallery ul_li clearfix">
									<li>
										<a class="popup_image" href="market/assets/images/instagram/img_01.jpg">
											<img src="market/assets/images/instagram/img_01.jpg" alt="image_not_found">
										</a>
									</li>
									<li>
										<a class="popup_image" href="market/assets/images/instagram/img_02.jpg">
											<img src="market/assets/images/instagram/img_02.jpg" alt="image_not_found">
										</a>
									</li>
									<li>
										<a class="popup_image" href="market/assets/images/instagram/img_03.jpg">
											<img src="market/assets/images/instagram/img_03.jpg" alt="image_not_found">
										</a>
									</li>
									<li>
										<a class="popup_image" href="market/assets/images/instagram/img_04.jpg">
											<img src="market/assets/images/instagram/img_04.jpg" alt="image_not_found">
										</a>
									</li>
									<li>
										<a class="popup_image" href="market/assets/images/instagram/img_05.jpg">
											<img src="market/assets/images/instagram/img_05.jpg" alt="image_not_found">
										</a>
									</li>
									<li>
										<a class="popup_image" href="market/assets/images/instagram/img_06.jpg">
											<img src="market/assets/images/instagram/img_06.jpg" alt="image_not_found">
										</a>
									</li>
								</ul>
					...
					<div class="row align-items-center justify-content-lg-between">
						...
						<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
							<div class="payment_methods float-lg-right">
								<img src="market/assets/images/payment_methods_01.png" alt="image_not_found">
							</div>
						</div>
					</div>
				</div>
		...
		<script src="market/assets/js/jquery-3.5.1.min.js"></script>
		<script src="market/assets/js/popper.min.js"></script>
		<script src="market/assets/js/bootstrap.min.js"></script>

		<!-- mobile menu - jquery include -->
        <script src="market/assets/js/mCustomScrollbar.js"></script>

		<!-- google map - jquery include -->
		<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDk2HrmqE4sWSei0XdKGbOMOHN3Mm2Bf-M&ver=2.1.6"></script>
        <script src="market/assets/js/gmaps.min.js"></script>

		<!-- animation - jquery include -->
        <script src="market/assets/js/parallaxie.js"></script>
        <script src="market/assets/js/wow.min.js"></script>

		<!-- nice select - jquery include -->
        <script src="market/assets/js/nice-select.min.js"></script>

		<!-- carousel - jquery include -->
        <script src="market/assets/js/slick.min.js"></script>

		<!-- countdown timer - jquery include -->
        <script src="market/assets/js/countdown.js"></script>

		<!-- popup images & videos - jquery include -->
        <script src="market/assets/js/magnific-popup.min.js"></script>

		<!-- filtering & masonry layout - jquery include -->
        <script src="market/assets/js/isotope.pkgd.min.js"></script>
        <script src="market/assets/js/masonry.pkgd.min.js"></script>
        <script src="market/assets/js/imagesloaded.pkgd.min.js"></script>

		<!-- jquery ui - jquery include -->
        <script src="market/assets/js/jquery-ui.js"></script>

		<!-- custom - jquery include -->
		<script src="market/assets/js/custom.js"></script>
		...
		<div class="quickview_modal modal fade" id="quickview_modal" tabindex="-1" role="dialog" aria-hidden="true">
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content clearfix">
					...
					<div class="item_image">
						<img src="market/assets/images/shop/fashion_minimal/img_07.jpg" alt="image_not_found">
					</div>
					<div class="item_content">
