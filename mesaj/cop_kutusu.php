<?
	...
	$rows_mesaj 			= $cSubData->getMesajCop();
...
<body class="mod-bg-1">
                ...
                <div class="position-absolute pos-top pos-bottom w-100">
                    <div class="d-flex h-100 flex-column">
                        ...
                        <div class="flex-1 pr-3">
                            ...
                            <a href="/mesaj/cop_kutusu.do?route=mesaj/cop_kutusu&sayfa=1" class="px-3 px-sm-4 pr-lg-3 pl-lg-5 py-2 fs-md d-flex bg-primary-300 justify-content-between rounded-pill border-top-left-radius-0 border-bottom-left-radius-0">
                ...
                <div class="flex-grow-0">
                    <div class="d-flex align-items-center pl-2 pr-3 py-3 pl-sm-3 pr-sm-4 py-sm-4 px-lg-5 py-lg-4  border-faded border-top-0 border-left-0 border-right-0 flex-shrink-0">
                        ...
                        <h1 class="subheader-title ml-1 ml-lg-0">
                            <i class="fas fa-trash mr-2 hidden-lg-down"></i><?=dil("Çöp Kutusu")?>
                        </h1>
                    ...
                    <div class="d-flex flex-wrap align-items-center pl-3 pr-1 py-2 px-sm-4 px-lg-5 border-faded border-top-0 border-left-0 border-right-0">
                        <div class="flex-1 d-flex align-items-center">
                            <div class="custom-control custom-checkbox mr-2 mr-lg-2 d-inline-block">
                                <input type="checkbox" class="custom-control-input" id="js-msg-select-all" onclick="fncSecim(this)">
                                <label class="custom-control-label bolder" for="js-msg-select-all"></label>
                            </div>
                            <a href="javascript:void(0);" id="js-delete-selected" class="btn btn-icon rounded-circle mr-1" title="<?=dil("Sil")?>"><i class="fas fa-times fs-md"></i></a>
                            <a href="javascript:void(0);" class="btn btn-icon rounded-circle mr-1" title="<?=dil("Yenile")?>" onclick="fncYenile(this);"><i class="fas fa-repeat fs-md"></i></a>
                        </div>
    ...
    <script>
		...
		function fncMesajSil(obj){
			...
			$.ajax({
				url: '/class/db_kayit.do?islem=mesaj_sil',
				type: "POST",				
				data : datastr,
				dataType: 'json',
				async: true,
