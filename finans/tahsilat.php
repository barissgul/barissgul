<?
	...
	$row = $cSubData->getTahsilat($_REQUEST);
	
	if(is_null($row->ID)){
		$row->CARI_ID 		= $_REQUEST['cari_id'];
		$row->PLAKA 		= $_REQUEST['plaka'];
		$row->FATURA_TARIH 	= $_REQUEST['fatura_tarih'];
	}
?>
<!DOCTYPE html>
        ...
        <section class="content">
        	<div class="panel">
				<div class="panel-hdr bg-primary-300">
                    <h2> <i class="fal fa-lira-sign mr-3"></i> <?=dil("Cari Hesap - Tahsilat Girişi")?> </h2>
                ...
                <div class="panel-container show">
                    <div class="panel-content">
						...
						<input type="hidden" name="islem" value="finans_tahsilat_kaydet">
						...
						<div class="row">
							...
							<div class="w-100"></div>
							<div class="col-md-6 col-xs-6 mb-2 senet1" style="display: none;"> 
								<div class="form-group">
