        ...
        <section class="content">
	    	...
	    	<div class="panel">
	            <div class="panel-hdr bg-primary-300">
	                <h2> <i class="fal fa-lira-sign mr-3"></i> <?=dil("Alacak Dekontu")?> </h2>
	            ...
	            <div class="panel-container show">
	                <div class="panel-content">
	                	<form name="formAlacakEkle" id="formAlacakEkle" class="" enctype="multipart/form-data" method="POST">
							<input type="hidden" name="islem" value="finans_alacak_dekontu_kaydet">
							...
							<div class="row">
								...
								<div class="col-md-3 mb-2"> 
									<div class="form-group">
									    <label class="form-label"><?=dil("Alacak Tarih")?></label>
