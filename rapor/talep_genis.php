<?
	...
	$Table = $cTable->setSayfa("sayfaTalepGenisRapor")->setExcel($excelOut)->setPost($_REQUEST)->Uygula()->getTable();	
	$rows = $Table['rows'];
...
<body class="mod-bg-1">
    ...
    <main id="js-page-content" role="main" class="page-content">
    	<ol class="breadcrumb page-breadcrumb breadcrumb-seperator-1">
            ...
            <li class="breadcrumb-item active"><?=dil("Talep Geniş Rapor")?></li>
			    	...
			    	<div class="panel" id="panel1">
			    		<div class="panel-hdr bg-primary-300">
                            ...
                            <div class="panel-toolbar">
                            	<a href="/talep/talep.do?route=talep/servis" class="btn btn-outline-secondary btn-icon waves-effect waves-themed text-white mr-2"><i class="fas fa-plus"></i></a>
						  		...
						  		<table class="table table-sm table-condensed table-hover">
							  		<thead class="thead-themed fw-500">
								    	<tr>
								          	...
								          	<td align="center"><?=dil("Tah.Teslim Tar.")?></td>
							        ...
							        <tbody>
								        <?foreach($rows as $key=>$row) {?>
									        <tr>
									          	...
									          	<td align="center"><?=FormatTarih::tarih($row->TAHMINI_TESLIM_TARIH)?></td>
