...
<body class="mod-bg-1">
    ...
    <main id="js-page-content" role="main" class="page-content">
    	<ol class="breadcrumb page-breadcrumb breadcrumb-seperator-1">
            ...
            <li class="breadcrumb-item active"><?=dil("Servis Talep Listesi")?></li>
								...
								<div class="row">
									...
									<div class="col-xl-2 col-sm-3 mb-2">        
									    <div class="form-group">
									      	...
									      	<input type="text" class="form-control" placeholder="" name="plaka" id="plaka" value="<?=$_REQUEST['plaka']?>" maxlength="25">
									    </div>
									</div>
									<div class="col-xl-2 col-sm-3 mb-2">        
									    <div class="form-group">
									      	<label class="form-label"> <?=dil("Dosya No")?> </label>
									      	<input type="text" class="form-control" placeholder="" name="dosya_no" id="dosya_no" value="<?=$_REQUEST['dosya_no']?>" maxlength="25">
									    </div>
									</div>
									<div class="col-xl-2 col-sm-3 mb-2">        
									    <div class="form-group">
								        ...
								        <div class="form-group">
								        	<label class="form-label">
									      		<div class="custom-control custom-switch custom-control-inline">
                                                    <input type="checkbox" class="custom-control-input" id="randevu_tarih_var" name="randevu_tarih_var" <?=($_REQUEST['randevu_tarih_var'])?' checked':''?>>
                                                    <label class="custom-control-label" for="randevu_tarih_var"><?=dil("Randevu Tarihi")?></label>
                                                </div>
                                            </label>
									      	<div class="input-group">
									      		<div class="input-group-prepend hidden-md"><span class="input-group-text fs-sm"><i class="far fa-calendar-alt"></i></span></div>
									          	<input type="text" class="form-control pull-right" id="randevu_tarih" name="randevu_tarih" value="<?=$_REQUEST['randevu_tarih']?>" readonly>
									        </div>
									    </div>
								    </div>								
								    <div class="col-xl-2 col-sm-4 mb-2">        
								        <div class="form-group">
								        	<label class="form-label">
									      	...
									      	<div class="input-group">
									      		<div class="input-group-prepend hidden-md"><span class="input-group-text fs-sm"><i class="far fa-calendar-alt"></i></span></div>
									          	<input type="text" class="form-control pull-right" id="arac_gelis_tarih" name="arac_gelis_tarih" value="<?=$_REQUEST['arac_gelis_tarih']?>" readonly>
									        </div>
									    </div>
								    </div>
								    <div class="col-xl-2 col-sm-4 mb-2">        
								        <div class="form-group">
								        	<label class="form-label">
									      		<div class="custom-control custom-switch custom-control-inline">
                                                    <input type="checkbox" class="custom-control-input" id="tahmini_teslim_tarih_var" name="tahmini_teslim_tarih_var" <?=($_REQUEST['tahmini_teslim_tarih_var'])?' checked':''?>>
                                                    <label class="custom-control-label" for="tahmini_teslim_tarih_var"><?=dil("Tahmini Teslim Tarihi")?></label>
                                                </div>
                                            </label>
									      	<div class="input-group">
									      		<div class="input-group-prepend hidden-md"><span class="input-group-text fs-sm"><i class="far fa-calendar-alt"></i></span></div>
									          	<input type="text" class="form-control pull-right" id="tahmini_teslim_tarih" name="tahmini_teslim_tarih" value="<?=$_REQUEST['tahmini_teslim_tarih']?>" readonly>
									        </div>
									    </div>
								    </div>
								    <div class="col-xl-2 col-sm-4 mb-2">        
	    	...
	    	<div class="row">
	    		<div class="col-md-12">
    				...
    				<div class="panel-hdr bg-primary-300 text-white">
                        <h2><i class="fa fa-list mr-3"></i> <?=dil("Servis Araç Listesi")?> &nbsp;<span class="small">(<?=$Table['sayfaUstYazi']?>)</span> </h2>
                        <div class="panel-toolbar">
                        	<a href="/excel_sql.do?" class="btn btn-outline-secondary btn-icon waves-effect waves-themed text-white border-white mr-2" title="Excel"><i class="fas fa-table"></i></a>
                        </div>
                    </div>
                    <div class="panel-container show">
                        <div class="panel-content">
							        ...
							        <tbody>
								        <?foreach($rows as $key=>$row) {?>
									        <tr>
									          	...
									          	<td> <?=$row->SUREC?></td>
									          	<td> <?=$row->SORUMLU?></td>
									          	<td align="center"><?=FormatTarih::tarih($row->ARAC_GELIS_TARIH)?></td>
