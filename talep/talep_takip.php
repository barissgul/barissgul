<?
	...
	$_REQUEST['filtre']		= 1;
	$Table = $cTable->setSayfa("sayfaTalepTakip")->setExcel($excelOut)->setPost($_REQUEST)->Uygula()->getTable();	
	$rows = $Table['rows'];
...
<body class="mod-bg-1">
    ...
    <main id="js-page-content" role="main" class="page-content">
    	<ol class="breadcrumb page-breadcrumb breadcrumb-seperator-1">
            ...
            <li class="breadcrumb-item active"><?=dil("Servis Takip")?></li>
	    	...
	    	<div class="row">
	    		<div class="col-md-12">
    				...
    				<div class="panel-hdr bg-primary-300 text-white">
                        <h2> <i class="far fa-wrench mr-3"></i> <?=dil("Servis Takip")?> &nbsp;<span class="small">(<?=$Table['sayfaUstYazi']?>)</span> </h2>
						  		...
						  		<table class="table table-sm table-condensed table-hover datatable">
							  		<thead class="thead-themed fw-500">
								    	<tr>
								          	...
								          	<td align="center"><?=dil("Tah.Tes.Tar")?></td>
