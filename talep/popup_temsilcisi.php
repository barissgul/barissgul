<?
	...
	session_kontrol();
	$row				= $cSubData->getTalepTemsilcisi($_REQUEST);
				    			...
				    			<div class="row">
					            	<?if(in_array($_SESSION['yetki_id'], array(1,2,3))){?>
						          	<div class="col-md-6 col-sm-6 mb-3">
						            	<div class="form-group">
										  	...
										  	<input type="text" class="form-control" placeholder="" name="kullanici" id="kullanici" maxlength="45" value="<?=$row->KULLANICI?>" readonly>
										</div>
									</div>
									<div class="col-md-6 col-sm-6 mb-3">
						            	<div class="form-group">
										  	<label class="form-label"><?=dil("Ünvan")?></label>
										  	<input type="text" class="form-control" placeholder="" name="unvan" id="unvan" maxlength="45" value="<?=$row->UNVAN?>" readonly>
										</div>
									</div>
									<?}?>
									<div class="col-md-12 col-sm-12 mb-3">
						            	<div class="form-group">
										  	...
										  	<input type="text" class="form-control" placeholder="" name="ad" id="ad" maxlength="45" value="<?=$row->ADSOYAD?>" readonly>
										</div>
									</div>
									<div class="col-md-12 col-sm-12 mb-3">
										<div class="form-group">
										  	...
										  	<div class="input-group">
										      	...
										      	<input type="text" class="form-control" placeholder="" name="mail" id="mail" value="<?=$row->MAIL?>" readonly="">
										    </div>
										</div>
									</div>
									<div class="col-md-6 col-sm-6 mb-3">
										<div class="form-group">
										  	...
										  	<div class="input-group">
										      	...
										      	<input type="text" class="form-control" placeholder="" name="tel" id="tel" value="<?=$row->TEL?>" readonly="">
										    </div>
										</div>
									</div>
									<div class="col-md-6 col-sm-6 mb-3">
										<div class="form-group">
										  	...
										  	<div class="input-group">
										      	...
										      	<input type="text" class="form-control" placeholder="" name="ceptel" id="ceptel" value="<?=$row->CEPTEL?>" readonly="">
										    </div>
										</div>
									</div>
								</div>
